...
- <strong>element.nextSibling/element.previousSibling</strong> - gets the next/previous node in the parent elements child node list. Note: Includes text nodes. (full support) 
